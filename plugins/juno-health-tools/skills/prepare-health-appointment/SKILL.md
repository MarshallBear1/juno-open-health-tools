---
name: prepare-health-appointment
description: Turn disorganised personal health notes into a concise, factual appointment brief. Use when someone asks to prepare for a clinician visit, prioritise appointment questions, summarise recent changes, or communicate functional impact without seeking diagnosis or treatment advice.
---

# Prepare a health appointment
...
4. List medicines only as the user states them; never correct doses from memory.
5. Put the user's questions in priority order and add at most two neutral process questions.
